...
| Recovery-Mode
| Modus zur temporären Anpassung von Anforderungen in stressigen Phasen, um Nutzer:innen beim Wiedereinstieg zu unterstützen. Bildet sich im Domänenmodell als RecoveryPhase ab.
| Anpassungsmodus
...
Nutzer "1" -- "0..*" RecoveryPhase : legt ein
...
| RecoveryPhase
| Repräsentiert einen Zeitraum (Recovery-Mode), in dem der Nutzer temporär verminderte Anforderungen hat, um in stressigen Phasen Rückschläge bei Streaks abzufedern.
...
| RecoveryPhase
| 1 zu 0..*
| Ein Nutzer kann in Belastungsphasen Recovery-Phasen einlegen, die sich auf das Tracking auswirken.
