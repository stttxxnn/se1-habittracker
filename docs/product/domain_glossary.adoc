...
| Nutzer
| Verwaltet persönliche Gewohnheiten, Fortschritte und soziale Interaktionen innerhalb der Anwendung.

| Gewohnheit
| Beschreibt eine wiederkehrende Aktivität, die ein Nutzer regelmäßig durchführen möchte.

| Gewohnheitsabschluss
| Dokumentiert die erfolgreiche Durchführung einer Gewohnheit zu einem bestimmten Zeitpunkt.

| Streak
| Speichert die aktuelle und längste Erfolgsserie eines Nutzers.

| Planung
| Enthält Informationen zur zeitlichen Planung und Wiederholung von Gewohnheiten.

| Benachrichtigung
| Informiert Nutzer über Erinnerungen, Meilensteine oder wichtige Ereignisse.

| Meilenstein
| Repräsentiert erreichte Fortschritte oder Ziele innerhalb einer Gewohnheit.

| Statistik
| Zeigt Auswertungen und Trends zum Fortschritt des Nutzers.
|===
